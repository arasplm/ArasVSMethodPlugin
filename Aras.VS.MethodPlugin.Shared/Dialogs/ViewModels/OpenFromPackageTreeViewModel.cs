...
using Aras.VS.MethodPlugin.Properties;
...
namespace Aras.VS.MethodPlugin.Dialogs.ViewModels
{
	public class OpenFromPackageTreeViewModel : BaseViewModel
	{
			...
			string lastUsedSearchType)
		{
			...
			{
				{ searchByContentKey, new SearchType() { Icon = Resources.searchByContent, TypeName = "Search by method content" } },
				{ searchByFileNameKey, new SearchType() { Icon = Resources.searchFile, TypeName = "Search by method name" } }
			};
