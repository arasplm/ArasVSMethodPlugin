//------------------------------------------------------------------------------
// <copyright file="AssemblyInfo.cs" company="Aras Corporation">
...
[assembly: AssemblyTitle("Aras Innovator Method Plugin")]
[assembly: AssemblyDescription("Aras Innovator Method Plugin provides easy way to create and modify Aras Innovator server-side methods. Method code can be open or saved directly from/to an instance of Aras Innovator or from/to a local AML package. Aras Innovator Method Plugin for Visual Studio has also additional capabilities like generating template code to unit test the method; creating a new package directly in Aras Innovator prior to saving the method in it; etc. The Plugin provides extension for Visual Studio with all operations and project templates for different releases of Aras Innovator starting with Aras Innovator 11 SP8. Aras Corporation provides this plugin as is and will not provide any support or other related services related to this plugin.")]
[assembly: AssemblyConfiguration("")]
[assembly: AssemblyCompany("Aras Corporation")]
[assembly: AssemblyProduct("Aras Innovator Method Plugin")]
[assembly: AssemblyCopyright("© 2017-2023 Aras Corporation. All rights reserved.")]
